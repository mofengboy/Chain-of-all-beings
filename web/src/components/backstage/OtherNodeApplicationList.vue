<template>
  <div>
    <p class="application-title">来自其他节点的申请书</p>
    <el-divider/>
    <div v-if="isMainNode">
...
export default {
  ...
  data() {
    ...
    getListOfOtherNodeApplication: function () {
      ...
      this.axios({
        method: "post",
        url: "/backstage/main_node/other_apply_list/get",
        data: reqData,
    ...
    getDetailOfOtherNodeApplication: function (db_id) {
      ...
      return this.axios({
        method: "post",
        url: "/backstage/main_node/other_apply/get",
        data: JSON.stringify({
          db_id: db_id,
          token: _this.token
        }),
    ...
    handlePass: function (db_id, review) {
      ...
      this.axios({
        method: "post",
        url: "/backstage/main_node/other_apply/review",
        data: JSON.stringify({
          db_id: db_id,
          token: _this.token,
          is_review: review
